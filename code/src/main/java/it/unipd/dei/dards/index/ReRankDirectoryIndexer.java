 ...
 * @since 1.00
 */
public class ReRankDirectoryIndexer {
     ...
     */
    public ReRankDirectoryIndexer(final Analyzer analyzer, final Similarity similarity, final int ramBufferSizeMB,
   ...
   /* public HashMap<Integer, HashMap> tfIdfScore() {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ReRankDirectoryIndexer i = new ReRankDirectoryIndexer(a, sim, ramBuffer, indexPath, docsPath, extension,
