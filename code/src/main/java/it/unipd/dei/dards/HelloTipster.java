...
public class HelloTipster {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // second indexer
        //myDirectoryIndexer i_reRank = new myDirectoryIndexer(a_docs, sim, ramBuffer, reRankIndexPath, docsPath, extension, charsetName,
        //        maxDocsRetrieved, TipsterParser.class);

        //second searcher
        //mySearcher s_reRank = new mySearcher(a_query, sim, reRankIndexPath, topics, expectedTopics, runID, runPath, maxDocsRetrieved);
